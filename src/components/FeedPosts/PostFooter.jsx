import { Flex, Text, Box, Input, InputGroup, InputRightElement, Button } from '@chakra-ui/react'
    ...
    <Box mb={8} marginTop={'auto'}>
        ...
        <>
            ...
            {post.comments.length>0 &&
                <Text color={'gray'} fontSize={'sm'}>View all {post.comments.length} comments</Text>
            }
        </>)}
        {authUser && (
